 ...
 *
 * \param path Path to assess
 * \returns True if this is an C file
 */
bool is_c(const char *path, bool all_files);
 ...
 * \returns True if this is an C++ file
 */
bool is_cxx(const char *path, bool all_files);
...
/** find name in PATH and check is X, return true on success, false on failure **/
